 ...
 * @returns {Numeral[]}
 */
export function create_zero_array(n: number): Numeral[];
...
export class Polynomial extends Expression {
    ...
    /**
     * @param {import('../expression/expression.js').Shorthand[]} coeffs
     ...
     */
    constructor(coeffs: import('../expression/expression.js').Shorthand[], options?: {
        ascending?: boolean | undefined;
        variable?: string | Variable | undefined;
    } | undefined);
    ...
    get leadingCoefficient(): import("../expression/expression.js").ExpressionNode;
    /** @returns {ExpressionNode} */
    get constantTerm(): import("../expression/expression.js").ExpressionNode;
    /** @returns {Polynomial} */
    clone(): Polynomial;
    /**
